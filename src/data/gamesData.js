...
export const lotteryGames = [
  { id:1,  name:"Keno",                image:c(0),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Keno"    },
  { id:2,  name:"Bingo 90",            image:c(1),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Bingo"   },
  { id:3,  name:"Bingo 75",            image:c(2),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Bingo"   },
  { id:4,  name:"Lotto 6/49",          image:c(3),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Lotto"   },
  { id:5,  name:"Powerball",           image:c(4),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Jackpot" },
  { id:6,  name:"Mega Millions",       image:c(5),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Jackpot" },
  { id:7,  name:"Euro Millions",       image:c(6),  category:"Lottery", badge:"NEW",  ...def, subCategory:"Lotto"   },
  { id:8,  name:"Scratch Card",        image:c(7),  category:"Lottery", badge:"NEW",  ...def, subCategory:"Scratch" },
  { id:9,  name:"Lucky Numbers",       image:c(8),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Lotto"   },
  { id:10, name:"Pick 3",              image:c(9),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Keno"    },
  { id:11, name:"Pick 4",              image:c(0),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Keno"    },
  { id:12, name:"Daily Draw",          image:c(1),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Lotto"   },
  { id:13, name:"Rapid Keno",          image:c(2),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Keno"    },
  { id:14, name:"Super Lotto",         image:c(3),  category:"Lottery", badge:"NEW",  ...def, subCategory:"Lotto"   },
  { id:15, name:"Thunderball",         image:c(4),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Jackpot" },
  { id:16, name:"Set For Life",        image:c(5),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Jackpot" },
  { id:17, name:"Cash 5",              image:c(6),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Lotto"   },
  { id:18, name:"Win 4",               image:c(7),  category:"Lottery", badge:"NEW",  ...def, subCategory:"Keno"    },
  { id:19, name:"Instant Win",         image:c(8),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Scratch" },
  { id:20, name:"Lucky Stars",         image:c(9),  category:"Lottery", badge:"LIVE", ...def, subCategory:"Scratch" },
  { id:21, name:"Lotto Max",           image:c(0),  category:"Lottery", badge:"HOT",  ...def, subCategory:"Lotto"   },
  { id:22, name:"Mega Jackpot",        image:c(1),  category:"Lottery", badge:"NEW",  ...def, subCategory:"Jackpot" },
];

// ── SPORTSBOOK ───────────────────────────────────────────────────
export const sportsbookGames = [
  { id:1,  name:"Cricket - IPL",       image:c(4),  category:"Sports", badge:"LIVE", ...def, subCategory:"Cricket"    },
  { id:2,  name:"Cricket - T20 WC",    image:c(5),  category:"Sports", badge:"LIVE", ...def, subCategory:"Cricket"    },
  { id:3,  name:"Football - EPL",      image:c(6),  category:"Sports", badge:"LIVE", ...def, subCategory:"Football"   },
  { id:4,  name:"Football - La Liga",  image:c(7),  category:"Sports", badge:"LIVE", ...def, subCategory:"Football"   },
  { id:5,  name:"Football - UCL",      image:c(8),  category:"Sports", badge:"HOT",  ...def, subCategory:"Football"   },
  { id:6,  name:"Tennis - Wimbledon",  image:c(9),  category:"Sports", badge:"HOT",  ...def, subCategory:"Tennis"     },
  { id:7,  name:"Tennis - US Open",    image:c(0),  category:"Sports", badge:"NEW",  ...def, subCategory:"Tennis"     },
  { id:8,  name:"Basketball - NBA",    image:c(1),  category:"Sports", badge:"LIVE", ...def, subCategory:"Basketball" },
  { id:9,  name:"Kabaddi - PKL",       image:c(2),  category:"Sports", badge:"LIVE", ...def, subCategory:"Others"     },
  { id:10, name:"Horse Racing",        image:c(3),  category:"Sports", badge:"HOT",  ...def, subCategory:"Others"     },
  { id:11, name:"Badminton",           image:c(4),  category:"Sports", badge:"NEW",  ...def, subCategory:"Others"     },
  { id:12, name:"Boxing",              image:c(5),  category:"Sports", badge:"HOT",  ...def, subCategory:"Others"     },
  { id:13, name:"Table Tennis",        image:c(6),  category:"Sports", badge:"LIVE", ...def, subCategory:"Tennis"     },
  { id:14, name:"Volleyball",          image:c(7),  category:"Sports", badge:"LIVE", ...def, subCategory:"Others"     },
  { id:15, name:"Rugby",               image:c(8),  category:"Sports", badge:"HOT",  ...def, subCategory:"Others"     },
  { id:16, name:"Golf",                image:c(9),  category:"Sports", badge:"NEW",  ...def, subCategory:"Others"     },
  { id:17, name:"MMA / UFC",           image:c(0),  category:"Sports", badge:"HOT",  ...def, subCategory:"Others"     },
  { id:18, name:"Snooker",             image:c(1),  category:"Sports", badge:"LIVE", ...def, subCategory:"Others"     },
  { id:19, name:"Baseball - MLB",      image:c(2),  category:"Sports", badge:"HOT",  ...def, subCategory:"Others"     },
  { id:20, name:"Ice Hockey - NHL",    image:c(3),  category:"Sports", badge:"LIVE", ...def, subCategory:"Others"     },
  { id:21, name:"E-Sports - CSGO",     image:c(4),  category:"Sports", badge:"HOT",  ...def, subCategory:"E-Sports"   },
  { id:22, name:"E-Sports - DOTA2",    image:c(5),  category:"Sports", badge:"NEW",  ...def, subCategory:"E-Sports"   },
];

// ── EXCHANGE ─────────────────────────────────────────────────────
export const exchangeGames = [
  { id:1,  name:"Cricket Match Odds",  image:c(4),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Cricket"  },
  { id:2,  name:"Cricket Fancy",       image:c(5),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Fancy"    },
  { id:3,  name:"Cricket Bookmaker",   image:c(6),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Cricket"  },
  { id:4,  name:"Cricket Session",     image:c(7),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Session"  },
  { id:5,  name:"Innings Runs",        image:c(8),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Session"  },
  { id:6,  name:"Player Runs",         image:c(9),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Fancy"    },
  { id:7,  name:"Wickets Market",      image:c(0),  category:"Exchange", badge:"NEW",  ...def, subCategory:"Fancy"    },
  { id:8,  name:"Toss Winner",         image:c(1),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Cricket"  },
  { id:9,  name:"Boundary Count",      image:c(2),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Fancy"    },
  { id:10, name:"Man of the Match",    image:c(3),  category:"Exchange", badge:"NEW",  ...def, subCategory:"Fancy"    },
  { id:11, name:"Football Match Odds", image:c(4),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Football" },
  { id:12, name:"Football Over/Under", image:c(5),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Football" },
  { id:13, name:"Correct Score",       image:c(6),  category:"Exchange", badge:"NEW",  ...def, subCategory:"Football" },
  { id:14, name:"Both Teams Score",    image:c(7),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Football" },
  { id:15, name:"Asian Handicap",      image:c(8),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Football" },
  { id:16, name:"Half Time Result",    image:c(9),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Football" },
  { id:17, name:"Tennis Match Odds",   image:c(0),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Tennis"   },
  { id:18, name:"Horse Race Odds",     image:c(1),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Session"  },
  { id:19, name:"Series Winner",       image:c(2),  category:"Exchange", badge:"NEW",  ...def, subCategory:"Cricket"  },
  { id:20, name:"Top Batsman",         image:c(3),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Fancy"    },
  { id:21, name:"Top Bowler",          image:c(4),  category:"Exchange", badge:"LIVE", ...def, subCategory:"Fancy"    },
  { id:22, name:"Over/Under Runs",     image:c(5),  category:"Exchange", badge:"HOT",  ...def, subCategory:"Session"  },
];
...
export const crashGames = [
  { id:1,  name:"Aviator",            image:c(3),  category:"Crash", subCategory:"Aviator",    provider:"Demo", badge:"HOT",  tags:["crash","popular"], isNew:false, isFeatured:true,  isPopular:true,  description:"", gameUrl:null },
  { id:2,  name:"JetX",               image:c(4),  category:"Crash", subCategory:"JetX",       provider:"Demo", badge:"HOT",  tags:["crash"],          isNew:false, isFeatured:false, isPopular:true,  description:"", gameUrl:null },
  { id:3,  name:"Crash Evolution",    image:c(5),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"NEW",  tags:["crash"],          isNew:true,  isFeatured:false, isPopular:false, description:"", gameUrl:null },
  { id:4,  name:"Crash Single",       image:c(6),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"LIVE", tags:["crash"],          isNew:false, isFeatured:false, isPopular:false, description:"", gameUrl:null },
  { id:5,  name:"GoRush",             image:c(7),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"HOT",  tags:["crash"],          isNew:false, isFeatured:false, isPopular:true,  description:"", gameUrl:null },
  { id:6,  name:"Limbo",              image:c(8),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"HOT",  tags:["crash"],          isNew:false, isFeatured:false, isPopular:true,  description:"", gameUrl:null },
  { id:7,  name:"Aero",               image:c(9),  category:"Crash", subCategory:"JetX",       provider:"Demo", badge:"NEW",  tags:["crash"],          isNew:true,  isFeatured:false, isPopular:false, description:"", gameUrl:null },
  { id:8,  name:"Balloon",            image:c(0),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"LIVE", tags:["crash"],          isNew:false, isFeatured:false, isPopular:false, description:"", gameUrl:null },
  { id:9,  name:"Cricket X",          image:c(4),  category:"Crash", subCategory:"Cricket X",  provider:"Demo", badge:"HOT",  tags:["crash","cricket"],isNew:false, isFeatured:true,  isPopular:true,  description:"", gameUrl:null },
  { id:10, name:"Football X",         image:c(5),  category:"Crash", subCategory:"Football X", provider:"Demo", badge:"HOT",  tags:["crash","football"],isNew:false,isFeatured:true,  isPopular:true,  description:"", gameUrl:null },
  { id:11, name:"Other Crash Demo",   image:c(1),  category:"Crash", subCategory:"Other",      provider:"Demo", badge:"NEW",  tags:["crash"],          isNew:true,  isFeatured:false, isPopular:false, description:"", gameUrl:null },
];
