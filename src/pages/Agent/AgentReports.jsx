...
import { FaUsers, FaMoneyBillWave, FaArrowCircleUp, FaExchangeAlt } from "react-icons/fa";
...
const AgentReports = () => {
  ...
  useEffect(() => {
    agentReport().then(r => { if (r?.success) setData(r.data); }).finally(() => setLoading(false));
  }, []);
