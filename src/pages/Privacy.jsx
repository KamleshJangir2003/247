  ...
  return (
    <div className="auth-page">
      ...
      <div className="privacy-box">
        ...
        <h4>Personal Data</h4>
        <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information. This may include:</p>
        <ul>
          <li>Email address</li>
        ...
        <p>When You access the Service by or through a mobile device, We may collect certain information automatically, including the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use.</p>

        <h3>Information from Third-Party Social Media Services</h3>
        <p>The Company allows You to create an account and log in through the following Third-party Social Media Services:</p>
        <ul>
          <li>Google</li>
          <li>Facebook</li>
          <li>Instagram</li>
        ...
        <p>If You decide to register through a Third-Party Social Media Service, We may collect Personal data already associated with that account, such as Your name, email address, activities or contact list.</p>
        ...
        <ul>
          <li><strong>Necessary / Essential Cookies</strong> — Type: Session Cookies. Purpose: Essential to provide You with services available through the Website and to enable You to use some of its features.</li>
        ...
        <ul>
          ...
          <li>For the performance of a contract with Us through the Service.</li>
        ...
        <ul>
          ...
          <li><strong>With other users</strong> when You share personal information in public areas of the Service.</li>
          <li><strong>With Your consent</strong> for any other purpose.</li>
        </ul>

        <h2>Retention of Your Personal Data</h2>
        <p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to comply with our legal obligations, resolve disputes, and enforce our legal agreements and policies.</p>
