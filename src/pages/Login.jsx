  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-box">
        ...
        <button className="btn" onClick={handleLogin}>Login <FaSignInAlt /></button>
        <button className="btn btn-demo" onClick={handleDemoLogin}>Login with demo ID <FaSignInAlt /></button>
